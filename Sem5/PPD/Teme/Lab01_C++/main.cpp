...
void readMatrix(double matrix[MAX][MAX], int n, int m, const string &fileName) {
...
void writeResult(double data[MAX][MAX], int n, int m, const string &fileName) {
...
double applyFilter(double matrix[MAX][MAX], int n, int m, int N, int M, int x, int y) {
    double sum = 0;
...
void resolveSequential(double input[MAX][MAX], double output[MAX][MAX],
...
void applyFilterParallelDistributed(int startI, int endI, int startJ, int endJ, int n, int m, int N,
                                    int M, double input[MAX][MAX], double output[MAX][MAX]) {
...
void resolveParallelDistributed(double input[MAX][MAX], double output[MAX][MAX],
